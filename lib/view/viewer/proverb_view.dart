...
import '../../vm/viewer/proverb_vm.dart';
import '../../widget/provider/provider_widget.dart';

class ProverbView extends StatefulWidget {
  static const String routeName = RouteNames.proverbScreen;
  ...
  @override
  ProverbViewState createState() => ProverbViewState();
}

@visibleForTesting
class ProverbViewState extends State<ProverbView>
    with BackNavigatorMixin
    implements ProverbNavigator {
  ...
  Widget build(BuildContext context) {
    ...
    return ProviderWidget<ProverbVm>(
      ...
      consumerWithThemeAndLocalization:
        ...
        final proverbSynoyms = ListView.builder(
            shrinkWrap: true,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (vm.synonyms.isNotEmpty) proverbSynoyms,
                      ],
                    ),
                  ),
                ),
