...
import '../../vm/viewer/saying_vm.dart';
import '../../widget/provider/provider_widget.dart';

class SayingView extends StatefulWidget {
  static const String routeName = RouteNames.sayingScreen;
  ...
  @override
  SayingViewState createState() => SayingViewState();
}

@visibleForTesting
class SayingViewState extends State<SayingView>
    with BackNavigatorMixin
    implements SayingNavigator {
  ...
  Widget build(BuildContext context) {
    ...
    return ProviderWidget<SayingVm>(
      ...
      consumerWithThemeAndLocalization:
        ...
        final sayingSynoyms = ListView.builder(
            shrinkWrap: true,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (vm.synonyms.isNotEmpty) sayingSynoyms,
                      ],
                    ),
                  ),
                ),
