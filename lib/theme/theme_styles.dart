...
class TextStyles {
  ...
  static TextStyle get T1 => lato.bold.size(FontSizes.s14).letterSpace(.7);
  ...
  static TextStyle get Callout => lato.size(FontSizes.s14).letterSpace(1.75);

  static TextStyle get CalloutFocus => Callout.bold;

  static TextStyle get Btn => lato.bold.size(FontSizes.s14).letterSpace(1.75);

  static TextStyle get BtnSelected => lato.size(FontSizes.s14).letterSpace(1.75);

  static TextStyle get Footnote => lato.bold.size(FontSizes.s11);
